...
export default function CsrActivities() {
  ...
  const handleApply = async () => {
    ...
    try {
      await api.post(`/social/activities/${selectedActivity}/participate`, { proofUrl });
  ...
  const handleCreateActivity = async () => {
    try {
      await api.post('/social/activities', formData);
      ...
      <div className="flex justify-between items-center">
        ...
        {canManage && (
          <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>Create CSR Activity</DialogTitle>
              </DialogHeader>
              <div className="space-y-4 pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input value={formData.departmentId} onChange={e => setFormData({ ...formData, departmentId: e.target.value })} />
                </div>
